...
const Course = () => {
  return (
    <div className={styles.courseContainer}>
      <h1 className={styles.pa}>TCS BPS Mock Test</h1>
      ...
      <p className={styles.paragraph}>
        SkillGarage has begun the TCS BPS Mock Test Series to help candidates prepare thoroughly for the actual BPS Examination.
      </p>
      <h1 className={styles.pa}>TCS BPS Overview</h1>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.pa}>Check out the TCS BPS Overview table below:</h2>
      ...
      <h1 className={styles.pa}>TCS BPS Features</h1>
      <p className={styles.paragraph}>The important features of the TCS BPS Examination are added here</p>
      <ul className={styles.list}>
        ...
        <li>TCS BPS Test Series offered by SkillGarage, shows the scorecard after the candidate attempts the BPS Examination.</li>
      ...
      <h1 className={styles.pa}>Why should you attempt the TCS BPS mock test by SkillGarage?</h1>
      <p className={styles.paragraph}>The benefits of attempting the TCS BPS Examination are the following:</p>
      <ul className={styles.list}>
      ...
      <h1 className={styles.pa}>TCS BPS Syllabus</h1>
      <p>The TCS BPS Syllabus covers a wide range of topics across various subjects to assess the candidate's aptitude and skills. The syllabus is designed to test the numerical, verbal, and reasoning abilities of the candidates through different types of questions. The sections and topics included in the syllabus are as follows:</p>
      <p>Candidates should refer to the TCS BPS Syllabus before attending the TCS BPS Mock Test by SkillGarage and prepare well in advance. Check out the TCS BPS Syllabus attached below:</p>  
      <h2>Numerical Ability</h2>
      <ul className={styles.list} >
        <li>Numbers & Decimal Fractions</li>
        <li>Allegations and Mixtures</li>
        <li>Probability</li>
        <li>Series and Progressions</li>
        <li>Equations</li>
        <li>Averages</li>
        <li>Area, Shapes & Perimeter</li>
        <li>Ratios, Proportions, and Averages</li>
        <li>Divisibility</li>
      ...
      <ul className={styles.list}>
        ...
        <li>Puzzles</li>
        <li>Statements-Based Logical Questions</li>
        <li>Logical Venn Diagram-Based DI</li>
        <li>Visual / Spatial Reasoning</li>
        <li>Figural and Factual Analysis</li>
        <li>Decision-Making</li>
        <li>Questions on Word Pattern</li>
        <li>Letter Series-related Questions</li>
      </ul>
      <h2 className={styles.pa}>TCS BPS Exam Pattern</h2>
      <p className={styles.paragraph}>The TCS BPS exam has 50 questions. Candidates must answer all 50 questions in 50 minutes. The test is divided into three sections. The first section tests numerical ability. The second section tests reasoning ability. The third section tests quantitative aptitude.</p>
      <table className={styles.table}>
        <tbody>
          <tr>
            <th>Section</th>
          ...
          <tr>
            <td>Sections</td>
            <td>Numerical Ability, Reasoning Ability, Quantitative Aptitude</td>
          </tr>
        </tbody>
      </table>
    </div>
